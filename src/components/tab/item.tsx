...
export const TabItem: Component<Props> = (props) => {
  return (
    <li
      class={`relative inline-flex text-sm font-sans leading-snug items-center bg-slate-500 bg-opacity-0 hover:bg-opacity-5 overflow-hidden space-x-2 border-solid border-brand-default dark:border-gray-200 border-opacity-5 dark:border-opacity-5 border-b-2 ${
        props.class || ''
      }`}
      classList={{
