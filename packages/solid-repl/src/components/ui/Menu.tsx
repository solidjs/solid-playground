...
export const Menu: ParentComponent<MenuProps> = (props) => {
  return (
    <div
      class={`min-w-32 border-neutral-200 bg-white py-1 dark:border-neutral-700 dark:bg-neutral-800 z-[1000] rounded-lg border shadow-xl ${
        props.class || 'fixed'
      }`}
      style={props.style}
...
export const MenuItem: Component<MenuItemProps> = (props) => {
  return (
    <button
      class="w-full space-x-2 px-3 py-2 flex items-center text-left text-xs transition-colors"
      classList={{
