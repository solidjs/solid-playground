        ...
        <div
          ...
          <div class={`${showMenu() ? "flex flex-col md:flex-row justify-center bg-red-500" : "hidden"} md:items-center md:space-x-2 md:flex`}>
            ...
            >
              ...
              <span class="md:sr-only">{props.dark ? 'Light' : 'Dark'} mode</span>
            </button>

            <label
              class="flex flex-row space-x-1 items-center px-3 py-2 focus:outline-none focus:ring-1 rounded text-white opacity-80 hover:opacity-100 cursor-pointer"
              title="Import from JSON"
            >
              <input type="file" class="sr-only" onChange={uploadFile} accept=".json" />
              <Icon path={upload} class="h-6" style={{margin: "0px 0px 0px 0px"}}/>
              <span class="md:sr-only">Import from JSON</span>
            </label>
            ...
            >
              ...
              <span class="md:sr-only">Export to JSON</span>
            </button>
            ...
            >
              ...
              <span class="md:sr-only">Export to CodeSandbox</span>
            </button>

            <button
              type="button"
              onClick={shareLink}
              class="flex flex-row space-x-1 items-center px-3 py-2 focus:outline-none focus:ring-1 rounded"
              classList={{
            ...
            >
              ...
              <span class="md:sr-only">{copy() ? 'Copied to clipboard' : 'Share'}</span>
            </button>
          </div>
        </div>
        <button
