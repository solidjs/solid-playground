...
const commonHeaderButtonClass = "hidden md:block"
  ...
  return (
    ...
    >
      ...
      <div class="flex items-center space-x-2">
        ...
        <button
          type="button"
          class="px-3 py-2 focus:outline-none focus:ring-1 rounded text-white opacity-80 hover:opacity-100 visible md:hidden"
        ...
        <button
          ...
          class={`px-3 py-2 focus:outline-none focus:ring-1 rounded text-white opacity-80 hover:opacity-100 ${commonHeaderButtonClass}`}
        ...
        <label
          class={`px-3 py-2 focus:outline-none focus:ring-1 rounded text-white opacity-80 hover:opacity-100 cursor-pointer ${commonHeaderButtonClass}`}
        ...
        <button
          ...
          class={`${commonHeaderButtonClass} px-3 py-2 focus:outline-none focus:ring-1 rounded text-white opacity-80 hover:opacity-100 ${commonHeaderButtonClass}`}
        ...
        <button
          type="button"
          onClick={shareLink}
          class={`px-3 py-2 focus:outline-none focus:ring-1 rounded ${commonHeaderButtonClass}`}
          classList={{
